...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr"> 
	...
	<body background="Images/food.jpg">
		...
		<article>
			<section>
				<h2><center>Asiatique</center></h2>
				
				<fieldset> 
				<legend>Que voulez-vous cuisiner? </legend>
				<div align="center">
				<a class="link" href="asiaptitdej.php"><button class="btn" type="button"><img src="Images/petit déjeuner japonais.png" height ="120" width="160" /><span>Un petit déjeuner<br></span></button></a>
				<a class="link" href="asiaentree.php"><button class="btn" type="button"><img src="Images/entrée japonaise.png" height ="120" width="160" /><span>Une entrée<br></span></button></a>
				</div>
				<div align="center">
				<a class="link" href="asiaplat.php"><button class="btn" type="button"><img src="Images/plat japonais.png" height ="120" width="160" /><span>Un plat<br></span></button></a>
				<a class="link" href="asiadessert.php"><button class="btn" type="button"><img src="Images/dessert japonais.png" height ="120" width="160" /><span>Un dessert<br></span></button></a>
				</div>
				</fieldset> 

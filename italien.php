...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr"> 
	...
	<body background="Images/food.jpg">
		...
		<article>
			<section>
				<h2><center>Italien</center></h2>
				
				
				<fieldset> 
				<legend>Que voulez-vous cuisiner? </legend>
				<div align="center">
				<a class="link" href="italptitdej.php"><button class="btn" type="button"><img src="Images/capuccino.png" height ="120" width="160" /><span>Un petit déjeuner<br></span></button></a>
				<a class="link" href="italentree.php"><button class="btn" type="button"><img src="Images/salade.png" height ="120" width="160" /><span>Une entrée<br></span></button></a>
				</div>
				<div align="center">
				<a class="link" href="italplat.php"><button class="btn" type="button"><img src="Images/platita.png" height ="120" width="160" /><span>Un plat<br></span></button></a>
				<a class="link" href="italdessert.php"><button class="btn" type="button"><img src="Images/glace à l'italienne.jpg" height ="120" width="160" /><span>Un dessert<br></span></button></a>
				</div>
				</fieldset> 
